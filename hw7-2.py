...
## SI 206 - HW
## COMMENT WITH:
## Your section day/time: Thursdays 3-4pm
## Any names of people you worked with on this assignment: Mallory Robbins
...
def get_twitter_data(phrase):
	identifier = "twitter_{}".format(phrase)
	if identifier in CACHE_DICTION:
		print('using cache', phrase)
		desired = CACHE_DICTION[identifier]
	else:
		print('fetching', phrase)
		results = api.search(q = phrase)
		desired = results['statuses']
		CACHE_DICTION[identifier] = desired
